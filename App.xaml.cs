...
using TicketToolv2.Core.Services;
using TicketToolv2.Models;
using TicketToolv2.Services;
using TicketToolv2.ViewModels;
using TicketToolv2.Views;

namespace TicketToolv2;
...
public partial class App : Application
{
    ...
    private void ConfigureServices(HostBuilderContext context, IServiceCollection services)
    {
        ...
        services.AddTransient<HTMLViewModel>();
        services.AddTransient<HTMLPage>();
